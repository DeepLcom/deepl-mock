...
const languages = new Map([
    ...
    ['DE', {name: "German", type: 'both', formality: true, text: "Protonenstrahl"}],
    ...
    ['ES', {name: "Spanish", type: 'both', formality: true, text: "haz de protones"}],
    ['ET', {name: "Estonian", type: 'both', text: "prootonikiirgus"}],
    ['FI', {name: "Finnish", type: 'both', text: "protonisäde"}],
    ['FR', {name: "French", type: 'both', formality: true, text: "faisceau de protons"}],
    ['HU', {name: "Hungarian", type: 'both', text: "protonnyaláb"}],
    ['IT', {name: "Italian", type: 'both', formality: true, text: "fascio di protoni"}],
    ...
    ['NL', {name: "Dutch", type: 'both', formality: true, text: "protonenbundel"}],
    ['PL', {name: "Polish", type: 'both', formality: true, text: "wiązka protonów"}],
    ['PT', {name: "Portuguese", type: 'source', text: "feixe de prótons"}],
    ['PT-BR', {name: "Portuguese (Brazilian)", type: 'target', formality: true, text: "feixe de prótons"}],
    ['PT-PT', {name: "Portuguese (European)", type: 'target', formality: true, text: "feixe de prótons"}],
    ['RO', {name: "Romanian", type: 'both', text: "fascicul de protoni"}],
    ['RU', {name: "Russian", type: 'both', formality: true, text: "протонный луч"}],
...
function getTargetLanguages() {
    ...
    languages.forEach((lang, code) => {
        if (['target', 'both'].includes(lang.type)) target_languages.push({
            language: code,
            name: lang.name,
...
function translate(input, target_lang, source_lang) {
    ...
    return {detected_source_language: source_lang, text: text};
}
